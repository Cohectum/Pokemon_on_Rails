class PokemonTypesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @pokemon_type.save
        format.html { redirect_to pokemon_type_url(@pokemon_type), notice: "Pokemon type was successfully created." }
  ...
  def update
    respond_to do |format|
      if @pokemon_type.update(pokemon_type_params)
        format.html { redirect_to pokemon_type_url(@pokemon_type), notice: "Pokemon type was successfully updated." }
  ...
  private
    ...
    def pokemon_type_params
      params.require(:pokemon_type).permit(:pokemonId, :typeId, :pokemon_id, :type_id)
    end
end
