class PokemonsController < ApplicationController
  ...
  def index
    @pokemons = Pokemon.order(id: :asc).page(params[:page])
  end
  ...
  private
    ...
    def pokemon_params
      params.require(:pokemon).permit(:pokemonId, :name, :baseExperience, :hp, :attack, :defense, :specialAttack, :specialDefense, :speed, :weight, :height, :generationId)
    end
end
