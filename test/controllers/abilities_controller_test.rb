...
class AbilitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ability" do
    assert_difference("Ability.count") do
      post abilities_url, params: { ability: { abilityId: @ability.abilityId, effect: @ability.effect, flavourText: @ability.flavourText, name: @ability.name } }
    end
  ...
  test "should update ability" do
    patch ability_url(@ability), params: { ability: { abilityId: @ability.abilityId, effect: @ability.effect, flavourText: @ability.flavourText, name: @ability.name } }
