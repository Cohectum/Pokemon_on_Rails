...
class TypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create type" do
    assert_difference("Type.count") do
      post types_url, params: { type: { class: @type.class, name: @type.name, typeId: @type.typeId } }
    end
  ...
  test "should update type" do
    patch type_url(@type), params: { type: { class: @type.class, name: @type.name, typeId: @type.typeId } }
