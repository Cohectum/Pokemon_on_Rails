...
class PokemonAbilitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pokemon_ability" do
    assert_difference("PokemonAbility.count") do
      post pokemon_abilities_url, params: { pokemon_ability: { abilityId: @pokemon_ability.abilityId, ability_id: @pokemon_ability.ability_id, pokemonId: @pokemon_ability.pokemonId, pokemon_id: @pokemon_ability.pokemon_id } }
    end
  ...
  test "should update pokemon_ability" do
    patch pokemon_ability_url(@pokemon_ability), params: { pokemon_ability: { abilityId: @pokemon_ability.abilityId, ability_id: @pokemon_ability.ability_id, pokemonId: @pokemon_ability.pokemonId, pokemon_id: @pokemon_ability.pokemon_id } }
