...
class MovesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create move" do
    assert_difference("Move.count") do
      post moves_url, params: { move: { accuracy: @move.accuracy, effect: @move.effect, flavourText: @move.flavourText, moveId: @move.moveId, name: @move.name } }
    end
  ...
  test "should update move" do
    patch move_url(@move), params: { move: { accuracy: @move.accuracy, effect: @move.effect, flavourText: @move.flavourText, moveId: @move.moveId, name: @move.name } }
